...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateStatus = channel.unary_unary(
                ...
                request_serializer=task__pb2.UpdateStatusRequest.SerializeToString,
                response_deserializer=task__pb2.TaskResponse.FromString,
                _registered_method=True)
        self.GetStats = channel.unary_unary(
                '/task.TaskService/GetStats',
                request_serializer=task__pb2.Empty.SerializeToString,
                response_deserializer=task__pb2.StatsResponse.FromString,
                _registered_method=True)
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=task__pb2.UpdateStatusRequest.FromString,
                    response_serializer=task__pb2.TaskResponse.SerializeToString,
            ),
            'GetStats': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStats,
                    request_deserializer=task__pb2.Empty.FromString,
                    response_serializer=task__pb2.StatsResponse.SerializeToString,
            ),
    }
...
class TaskService(object):
    ...
    def UpdateStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/UpdateStatus',
            task__pb2.UpdateStatusRequest.SerializeToString,
            task__pb2.TaskResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def GetStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            task__pb2.StatsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
